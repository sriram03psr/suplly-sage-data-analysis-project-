...
with head:
        ...
        str_path = "C:\\Users\\Barath\\Documents\\Supply Sage\\Images\\logo.PNG"
...
if sel=='Upload Data':
    ...
    if ax1:
        str_path = "C:\\Users\\Barath\\Documents\\Supply Sage\\Images\\cust.PNG"
        img = pl.open(str_path)
    ...
    if ax2:
        str_path = "C:\\Users\\Barath\\Documents\\Supply Sage\\Images\\prod.PNG"
        img = pl.open(str_path)
        st.image(img, width=350)
    ...
    if ax3:
        str_path = "C:\\Users\\Barath\\Documents\\Supply Sage\\Images\\targ.PNG"
        img = pl.open(str_path)
        st.image(img, width=350)
    ...
    if ax4:
        str_path = "C:\\Users\\Barath\\Documents\\Supply Sage\\Images\\ord.PNG"
        img = pl.open(str_path)
